                                    ...
                                    <div style="display: none;" id="<%=unit.getConid()%>_dialog" title="Editting <%=unit.getContype()%>">
                                        <form action="action/conroomaction.jsp" method="post" onsubmit="return validateForm();" name="edit">
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button class="btn btn-danger btn-large" type="submit" name="action" value="units" onclick='updateUnit("uname_<%=unit.getConid()%>","unitid_<%=unit.getConid()%>","uamount_<%=unit.getConid()%>");return false;'>
