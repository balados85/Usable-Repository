                        ...
                        <div style="padding-bottom: 80px;" class="span9 thumbnail well content">
                            <ul style="margin-left: 0px;" class="breadcrumb">
                                <li>
                                    ...
                                    <a> <i class="icon-tasks"></i>Complete The Fields Below To Add A New Supplier</a>
                                </li>

                            </ul>
                           
                                          <form action="addSup.jsp" method="post" onsubmit="return validateForm();" name="items" >
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="control-group">
                                                        <label class="control-label" for="input01"> Suppliers Name: </label>
                                                        <div class="controls">
                                                    ...
                                                    <div class="control-group">
                                                        <label class="control-label" for="input01">Item Supplied: </label>
                                                        <div class="controls">
                                                    ...
                                                    <div class="form-actions">
                                                        ...
                                                        <button class="btn btn-danger btn-large" type="submit" name="action" value="Add Supplier" id="b">
                                                            <i class="icon-arrow-right icon-white"> </i> Add Supplier 
                                                        </button>
