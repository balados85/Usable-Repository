...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = '<span style="float:right;">'+sSearchStr+'</span>';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select class="input-small" style="margin-top:5px;" size="1" '+sName+'>';
			...
			nLength.innerHTML = '<span float:left;">'+oSettings.oLanguage.sLengthMenu.replace( '_MENU_', sStdMenu )+'</span>';
