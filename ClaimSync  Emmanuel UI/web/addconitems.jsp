                        ...
                        <div style="padding-bottom: 80px;" class="span9 thumbnail well content">
                            <ul style="margin-left: 0px;" class="breadcrumb">
                                <li>
                                    ...
                                    <br/>
                                    <a> <i class="icon-tasks"></i>Complete The Fields Below To Add A New Consultation Type</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" class="dialog_link">

                                        <i class="icon-tasks"></i>Show Consultation Type
                                    </a>
                            ...
                            <form action="action/conroomaction.jsp" method="post" onsubmit="return validateForm();" name="items" >
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="input01">Amount: GHC</label>
                                        <div class="controls">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button class="btn btn-danger btn-large" type="submit" name="action" value="units" onclick='submitform();return false;'>
                                            <i class="icon-arrow-right icon-white"> </i> Add Type 
                                        </button>
                    ...
                    <table class="example display">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-group btn-medium" id="<%=unit.getConid()%>_link">
                                        <i class="icon-arrow-right icon-white"> </i> Edit 
                                    </button>
                                    <div style="display: none;" id="<%=unit.getConid()%>_dialog" title="Editting <%=unit.getContype()%>">
                                        <form action="action/conroomaction.jsp" method="post" onsubmit="return validateForm();" name="edit">
                                            <div class="control-group">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="uamount" id="uamount_<%=unit.getConid()%>" value="<%=unit.getAmount()%>">GHC
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button class="btn btn-danger btn-medium" type="submit" name="action" value="units" onclick='updateUnit("uname_<%=unit.getConid()%>","unitid_<%=unit.getConid()%>","uamount_<%=unit.getConid()%>");return false;'>
                                                    <i class="icon-arrow-right icon-white"> </i> Update Charges 
                                                </button>
                                ...
                                <td>
                                    <form action="action/conroomaction.jsp" method="post">
                                        ...
                                        <button class="btn btn-danger btn-medium" type="submit" name="action" value="units" onclick='deleteUnit("id_<%=unit.getConid()%>");return false;'>
...
<script type="text/javascript">
    ...
    function validateForm()
    {
        ...
        var x=document.forms["items"]["amount"].value;
        if (x==null || x=="")
        {
            //alert("Item must be filled out");
            return false;
        ...
        var x=document.forms["edit"]["uamount"].value;
        if (x==null || x=="")
        {
