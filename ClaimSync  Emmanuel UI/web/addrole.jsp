                    ...
                    <div style="margin-top: 0px; "class="span12 offset3 content1 hide">
                        ...
                        <div style="padding-bottom: 80px;" class="span9 thumbnail well content">
                            <ul style="margin-left: 0px;" class="breadcrumb">
                                <li>
                                    <a> <i class="icon-tasks"></i> Add additional roles</a>
                                </li>
                            ...
                            <form method="post" action="saveType.jsp">
                                ...
                                <div class="form-actions">
                                    ...
                                    <button class="btn btn-danger btn-large" type="submit" onclick="submitform();return false;">
                                        <i class="icon-arrow-right icon-white"> </i> Add Role 
                                    </button>
