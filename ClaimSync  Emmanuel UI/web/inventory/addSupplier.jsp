<%-- 
    ...
    Created on : Jul 5, 2012, 5:46:05 PM
    Author     : Lisandro
--%>
...
<li><a href="check.jsp">Check</a></li>
      ...
      <h2>Add New Supplier</h2>
        <p> 
        <pre>Complete The Fields Below To Add A New Supplier</pre>
        </p>
        ...
        <table border="1">
            ...
            <tr>
                ...
                <input type="hidden" name="lastName" value="not needed">
        ...
        <input type="submit" name ="action" value="Add Supplier"  id="b">
</form>
</body>
