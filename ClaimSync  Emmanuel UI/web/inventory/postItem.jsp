<%-- 
    Document   : postItem
    Created on : Jul 6, 2012, 10:52:26 AM
    Author     : Lisandro
--%>
...
<body>
    ...
    <%@page language="java"%>
    <div align="center"><h4>Complete The Fields Below To Post An Item</h4></div>
    <form method="post" action="send.jsp" name="items_form" onsubmit="return validateForm();">
        <table border="1">
            <tr><th>Date</th><th>Items</th><th>Item Id</th><th>Quantity</th><th>Unit</th><th>Recipient</th><th>Transaction Id</th></tr>
            <%try {
            ...
            <tr>
                ...
                <td><input type="text" name="transactionId" value="<%=ids%>" ></td>
                <td><input type="hidden" name="id" value="<%=ids%>"></td>
            </tr> 
            <tr>
                <td><input type="submit" name="Submit" value="Post"   style="background-color:#D1F0F6;font-weight:bold;color:white;"> </td>
