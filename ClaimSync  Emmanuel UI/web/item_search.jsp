<%-- 
    Document   : item_search
    Created on : Jun 25, 2012, 10:35:23 AM
    Author     : Lisandro
--%>
...
<html>
    ...
    <body >
        <div align="center"><h4>Search Result For Category Search</h4></div>
        <div align="right">
        ...
        <table border="1" align="center"  name="tabl">
            <form  name="form">
                <tr><th>Item Id</th><th>Items</th><th>Quantity</th><th>Unit</th><th>Price</th><th>Entry Date</th><th>Expiring Date</th><th>Item Type</th><th>Edit</th><th>Delete</th><th>Post Item</th></tr>
                <%
                    ...
                    List itmss = itm.searchItems(items);
