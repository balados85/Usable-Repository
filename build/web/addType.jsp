                    ...
                    <div style="margin-top: 0px; "class="span12 offset3 content1 hide">
                        ...
                        <div style="padding-bottom: 80px;" class="span9 thumbnail well content">
                            <ul style="margin-left: 0px;" class="breadcrumb">
                                <li>
                                    <a> <i class="icon-tasks"></i> Complete To Add New Item Or Drug Type</a>
                                </li>
                                            ...
                                            <form method="post" action="saveType.jsp">
                                                <fieldset>
                                                    ...
                                                    <div class="form-actions">
                                                        ...
                                                        <button class="btn btn-danger btn-large" type="submit" name="addType" value="Add Item Type">
                                                            <i class="icon-arrow-right icon-white"> </i> Add Item Type 
                                                        </button>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <input type="hidden" name="id" value="1">
                                                     ...
                                                     <div class="form-actions">
                                                        ...
                                                        <button class="btn btn-danger btn-large" type="submit" name="addDrugType" value="Add Drug Type">
                                                            <i class="icon-arrow-right icon-white"> </i> Add Drug Type 
                                                        </button>
