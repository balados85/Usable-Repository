            ...
            <section style="margin-top: -30px;" id="dashboard">
               ...
               <!--     <div style="height: 100%; position: fixed;" class="span3">
                        <ul style="display: none; " class="menu">
                            <li class="item1">
                                <a href="dashboard.php"><i class="icon-home"></i> Laboratory </a>
                                            ...
                                            <div class="dialog" id="<%=vst.getVisitid()%>_dialog" title="Enter Results">
                                                ...
                                                <div class="well thumbnail">
                                                    <ul style="margin-left: 0px;" class="breadcrumb">
                                                        ...
                                                        <!-- <li class="pull-right">
                                                             <button id="<%=vst.getVisitid()%>_adddrug_link" style="margin-top: -5px;" class="btn-small btn btn-danger">
                                                                 Add Drug
                                                             </button>
                                                         </li>-->
                                                    </ul>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td class="patient" rel="popover" data-original-title="<span style='text-align:center;'> <h3>Patient Information Summary </h3> <h5><%=mgr.getPatientByID(vst.getPatientid()).getFname()%> <%=mgr.getPatientByID(vst.getPatientid()).getLname()%></h5> <h5><b> Date of Birth :</b> <%=mgr.getPatientByID(vst.getPatientid()).getDateofbirth()%></h5> </span>"
                                                                     ...
                                                                     <td> <input type="text" name="results[]" value=""/><input type="hidden" name="ids[]" value="<%=ptPatienttreatments.getId()%>"/> </td>
