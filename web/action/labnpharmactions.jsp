            ...
            if (!patientid.equalsIgnoreCase("") || id != 0) {
                ...
                if (treatment != null) {
                    ...
                    for (int i = 0; i < treatment.length; i++) {
                        ...
                        mgr.addPatientTreatment(patientid, "CODE", Integer.parseInt(treatmentcode[1]), treatmentcode[4], mgr.getTreatment(Integer.parseInt(treatmentcode[1])).getPrice(), "", id, formatter.format(date), prescriptionnote, qty, treatmentcode[2]);
                ...
                if (labtest != null) {
                    ...
                    for (int i = 0; i < labtest.length; i++) {
                        ...
                        mgr.addPatientInvestigation(patientid, "CODE", Integer.parseInt(investigationcode[1]), "", mgr.getInvestigation(Integer.parseInt(investigationcode[1])).getPrice(), id, formatter.format(date), "", investigationnote, 0);
