<%-- 
    Document   : check
    Created on : Jul 4, 2012, 2:03:07 PM
    Author     : Lisandro
--%>
...
<%-- 
    Document   : check
    Created on : Jun 18, 2012, 11:11:48 AM
    Author     : Lisandro
--%>
    ...
    <body>
        ...
        <table border="1" align="center"  >
            <form method="post" name="form">
                <h4 align="center"><font color="red">This Product Has Expired</font></h4>

                <tr><th>Items Id</th><th>Items</th><th>Quantity</th><th>Price</th><th>Entry Date</th><th>Expiring Date</th><th>Edit</th><th>Delete</th></tr>
                <%
                    try {
                ...
                <tr><td><%=ids%></td>
                    ...
                    <td><%=date%></td>
                    <td><%=expDate%></td>
                    <td><input type="button" name="edit" value="Edit" style="background-color:#D1F0F6;font-weight:bold;color:white;" onClick="editRecord(<%=ids%>);" ></td>

                    </td>

                    <td><input type="button" name="delete" value="Delete" style="background-color:red;font-weight:bold;color:white;" onClick="show_confirm();deleteRecord(<%=ids%>); " ></td>
                </tr>
