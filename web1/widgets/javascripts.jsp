...
<script src="js/jquery.simpleValidate.min.js"></script>
...
<script type="text/javascript" charset="utf-8">
    ...
    $(function() {
        ...
        $("#select_payment").change(function() {
            if ( $("#select_payment").val() == "cash"){
                $("#payment").slideUp();
        
            } else if ( $("#select_payment").val() == "nhis"){
                $("#payment").slideUp();
            }
            else if ( $("#select_payment").val() == "cooperate"){
                $("#payment").slideUp();
            }
            else if ( $("#select_payment").val() == "private"){
                $("#payment").slideDown();
            }
